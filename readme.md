...
| ❄️🌀 Neon Climate Card (WebGL) | `neon-climate-card-webgl.js` | `1.2` | Same climate control, wind rendered by a real Navier-Stokes fluid solver (GLSL shaders); collapsible grouped UI editor |
