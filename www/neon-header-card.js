...
class NeonHeaderCard extends HTMLElement {
  ...
  _render() {
    ...
    const fontFamily  = c.font_family  ? `'${c.font_family}', var(--primary-font-family, 'Rajdhani', 'Share Tech Mono', sans-serif)` : `var(--primary-font-family, var(--ha-card-header-font-family, 'Rajdhani', 'Share Tech Mono', sans-serif))`;
